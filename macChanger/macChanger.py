#!/usr/bin/python3   
#Author : creepypirate
#To change the Mac Address of the specified interface

import subprocess   #can use the bash commands with this
...
def get_argument():
	...
	if not options.interface:
		...
		parser.error("[-] Specify a MacAddr use python macchanger --help for more details")
...
def getmac(interface):
	...
	current_mac = re.search(r"\w\w:\w\w:\w\w:\w\w:\w\w:\w\w",ifconfig_result.decode('utf-8')) #regex will not work on BLOBS hence need to convert to utf-8
